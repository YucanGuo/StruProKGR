...
class StruPro(object):
    ...
    def get_hits(self, answers, gold_answers, all_siment, query):
        ...
        mr = 0.0
        (e1, r) = query
        all_gold_answers = self.args.all_kg_map[(self.rev_entity_vocab[e1], self.rev_rel_vocab[r])]
...
if __name__ == '__main__':
    ...
    args.logger = Logger("logs", args.name_of_run + "_" + str(args.max_path_branch)).logger
